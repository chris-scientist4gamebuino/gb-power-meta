...
HelperScreenAnimation::HelperScreenAnimation() :
  AScreenAnimation()
{}

void HelperScreenAnimation::initialize() {
  this->isFinishedFlag = false;
  this->xOffset = SCREEN_WIDTH;
  this->timeController.reset();
}
//thanks to all people who help me during development
void HelperScreenAnimation::run() {
  char topLineText[] = "Thanks to all people";
  char bottomLineText[] = "who help me during development";
